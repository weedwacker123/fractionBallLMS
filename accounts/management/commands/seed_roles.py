...
SEED_ROLES = [
    ...
    },
    {
        ...
        'description': 'Can manage content, moderate community, and access CMS. Cannot manage users or schools.',
        'isSystem': True,
        'displayOrder': 2,
        'permissions': {
    ...
    },
    {
        ...
        'description': 'Basic authenticated user with access to community, library, dashboard, and notes.',
        'isSystem': True,
        'displayOrder': 3,
        'permissions': {
            'community.create': True,
